            ...
            <div className="flex gap-2">
              {options.map((option, index) => (
                <div
                  ...
                  onClick={() => onOptionClick(option.title, option.sleeve)}
                  style={
                ...
                >
                  <div className="flex flex-col items-start">
                    <div className="p-3">
                      ...
                      <div className="hidden">{option.sleeve}</div>
...
const SleeveAccordion = ({ selectedOption, onOptionChange }) => {
  ...
  const handleOptionClick = (optionTitle, optionSleeve) => {
    onOptionChange(optionSleeve);
  };

  return (
    <div className="w-full">
      <h1 className="font-black px-4 py-4">طراحی آستین</h1>
