...
export default function Navbar() {
  return (
    <nav class=" border-gray-200 absolute z-50 w-full">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
            class="btn-sm text-black bg-white hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2 text-center"
          >
            ساخت لباس
          </button>
          {/* <button
